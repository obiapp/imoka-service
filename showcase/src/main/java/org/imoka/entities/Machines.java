...
@NamedQueries({
    ...
    @NamedQuery(name = "Machines.selectAllByLastChange", query = "SELECT m FROM Machines m ORDER BY m.changed DESC")
})
public class Machines implements Serializable {
    ...
    public String toString() {
        return "org.imoka.entities.Machines[ id=" + id + " ]";
    }
