package org.imoka.service.Form;
...
import org.imoka.service.Form.util.Book;
import org.imoka.service.Form.util.ContactTree;
import org.imoka.service.Form.util.DeBelloGallico;
...
/**
 * In this example graphical components are put in dockables. The dockables can
 * be dragged and docked in different docks.
 *
 * Every dockable can be closed. When the dockable is added again later, the
 * dockable is docked as good as possible like it was docked before.
 *
 * Most of the dockables can be maximized, except the 'Find' panel.
 *
 * All the dockables can be minimized. The minimized components are also put in
 * dockables. They can be dragged and docked in other docks. They can also be
 * moved in their bar.
 *
 * There are some tool bars with buttons. The buttons can be moved in their tool
 * bar or dragged to other tool bars. The tool bars can also be dragged to other
 * borders or they can be made floating.
 *
 * The structure of the application window is like this: First there is a border
 * dock for tool bars with buttons. Inside that border dock is a minimizer that
 * minimizes the dockables at the borders. Inside the minimizer is a maximizer.
 * Inside the maximizer is the root dock for all the normal docks.
 *
 * When the application is stopped, the workspace is saved. When the application
 * is restarted again, the workspace is recovered. The dockables, docks,
 * minimized dockables, and button dockables are showed in the same state as
 * when they were closed.
 *
 * This example uses a float dock model. The model can be saved with a dock
 * model encoder. The model can be reloaded with a dock model decoder.
 *
 * @author Heidi Rakels
 */
...
//		dockables[0] = createDockable("Book1", 	 book1,      "Book 1",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 1<br><i>Gaius Julius Caesar</i><html>");
//		dockables[1] = createDockable("Book2",   book2,      "Book 2",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 2<br><i>Gaius Julius Caesar</i><html>");
//		dockables[2] = createDockable("Book3",   book3,      "Book 3",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 3<br><i>Gaius Julius Caesar</i><html>");
//		dockables[3] = createDockable("Book4",   book4,      "Book 4",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 4<br><i>Gaius Julius Caesar</i><html>");
//		dockables[4] = createDockable("Book5",   book5,      "Book 5",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 5<br><i>Gaius Julius Caesar</i><html>");
//		dockables[5] = createDockable("Book6",   book6,      "Book 6",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 6<br><i>Gaius Julius Caesar</i><html>");
//		dockables[6] = createDockable("Book7",   book7,      "Book 7",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 7<br><i>Gaius Julius Caesar</i><html>");
//		dockables[7] = createDockable("Book8",   book8,      "Book 8",  new ImageIcon(getClass().getResource("/img/javadocking/images/text12.gif")),     "<html>De Bello Gallico: Liber 8<br><i>Gaius Julius Caesar</i><html>");
//		dockables[8] = createDockable("Table",   table,      "Table",   new ImageIcon(getClass().getResource("/img/javadocking/images/table12.gif")),    "Table with hello");
//		dockables[9] = createDockable("Contacts",contactTree,"Contacts",new ImageIcon(getClass().getResource("/img/javadocking/images/person12.gif")),   "Sales Contacts");
//		dockables[10]= createDockable("Find",    find,       "Find",    new ImageIcon(getClass().getResource("/img/javadocking/images/binocular12.gif")),"Find a text");
//		dockables[11]= createDockable("Sales",   sales,      "Sales",   new ImageIcon(getClass().getResource("/img/javadocking/images/graph12.gif")),    "Sales of Books and CDs");
//		dockables[12]= createDockable("Words",   wordList,   "Words",   new ImageIcon(getClass().getResource("/img/javadocking/images/table12.gif")),    "Roman Gods");
...
//            centerDockingPath = DefaultDockingPath.copyDockingPath(CENTER_DOCKING_PATH_ID, DockingManager.getDockingPathModel().getDockingPath(dockables[0].getID()));
    ...
    /**
     * Creates the menubar with menus: File, Window, Look and Feel, and Drag
     * Painting.
     *
    ...
    /**
     * Creates a docking path for the dockable. This path is added to the
     * docking pah model of the docking manager. To create a docking path, the
     * dock model should already be given to the docking manager.
     *
    ...
    /**
     * A listener for window closing events. Saves the workspace, when the
    ...
    private class NewDockableAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            Dockable dockable = createDockable("new_window" + newDockableCount++, new TextPanel("I am window " + newDockableCount + "."), "I am very new dockable " + newDockableCount, new ImageIcon(getClass().getResource("/img/javadocking/images/hello12.gif")), "This is a dockable that was created when the user clicked an action");
            if (centerDockingPath != null) {
