...
public class MainFrame extends JFrame implements Callable<Integer> {
    ...
    public void setVisible(boolean visible) {
        ...
        ToolPanel explorer = new ToolPanel(docking, "Explorer",
                "explorer", DockableStyle.VERTICAL, 
                new ImageIcon(Objects.requireNonNull(getClass().getResource("/icons/light/icons8-vga-16.png"))));
