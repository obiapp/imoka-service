...
public class DateUtil {
    ...
    public static String formatDH(Date date){
     ...
     */
    public static boolean handleDateRangeFilters(Object value, Object filter, Locale locale) throws ParseException {
     ...
     * accomplished years
     */
    public static Integer yearsFrom(Date date) {
        if (date == null) {
            return 0;
        }
     ...
     */
    public static Integer daysOverYearsFrom(Date date) {
        if (date == null) {
            return 0;
        }
     ...
     */
    public static String durationFromMilliSec(Long milliSec) {
     ...
     * in seconde
     */
    public static Integer durationPartFromMilliSec(Long milliSec, Integer part) {
        Integer value = Integer.valueOf(milliSec.toString()) / 1000;
    ...
    public static Integer durationPFMS(Long milliSec, Integer part){
